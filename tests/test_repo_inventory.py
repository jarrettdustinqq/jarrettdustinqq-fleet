...
class ControllerRepoInventoryTests(unittest.TestCase):
    ...
    def test_archive_and_obsolete_repositories_remain_inactive(self) -> None:
        entries = set(self._active_entries())
        forbidden_active = {
        ...
        self.assertFalse(entries & forbidden_active, f"archive/obsolete repos activated: {sorted(entries & forbidden_active)}")
